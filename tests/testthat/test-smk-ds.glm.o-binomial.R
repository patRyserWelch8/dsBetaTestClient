...
# context("dsBetaTestClient::ds.glm.o:smk::binomial")

context("ds.glm.o::smk::binomial")
test_that("glm_binomial", {
    res <- ds.glm.o('D$DIS_DIAB~D$GENDER*D$PM_BMI_CONTINUOUS+D$LAB_HDL', family="binomial")
