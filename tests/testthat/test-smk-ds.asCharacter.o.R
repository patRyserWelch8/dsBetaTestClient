...
# context("dsBetaTestClient::ds.asCharacter.o:smk")
...
# context("dsBetaTestClient::ds.asCharacter.o::smk simple test")
context("ds.asCharacter.o::smk::simple test")
...
# context("dsBetaTestClient::ds.asCharacter.o 1::smk done")
