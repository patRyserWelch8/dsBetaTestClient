...
context("ds.rUnif.o()::expt::no_seeds::single")
...
context("ds.rUnif.o()::expt::no_seeds::multiple")
test_that("basic expectation",
{
...
context("ds.rUnif.o()::expt::seeds::single")
test_that("basic expectation",
{
  connect.dataset.2()
...
context("ds.rUnif.o()::expt::seeds::multiple")
test_that("basic expectation",
{
  connect.all.datasets()
