...
context("ds.var.o()::expt::single")
test_that("combined data set",
{
  connect.dataset.1()
  .test.var.combined('D$INTEGER',ds.test_env$local.values.1[,6])
  .test.var.combined('D$NON_NEGATIVE_INTEGER',ds.test_env$local.values.1[,7])
  .test.var.combined('D$POSITIVE_INTEGER',ds.test_env$local.values.1[,8])
  .test.var.combined('D$NEGATIVE_INTEGER',ds.test_env$local.values.1[,9]) 
  .test.var.combined('D$NUMERIC',ds.test_env$local.values.1[,10])
  .test.var.combined('D$NON_NEGATIVE_NUMERIC',ds.test_env$local.values.1[,11])
  .test.var.combined('D$POSITIVE_NUMERIC',ds.test_env$local.values.1[,12])
  .test.var.combined('D$NEGATIVE_NUMERIC',ds.test_env$local.values.1[,13]) 
})