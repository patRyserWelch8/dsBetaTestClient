...
context("ds.make.o()::expt::copy_data::multiple")
test_that("copy data without any changes applied",
{
...
context("ds.make.o()::expt::sum_of_two_vectors::single")
...
context("ds.make.o()::expt::sum_of_two_vectors::multiple")
...
context("ds.make.o()::expt::product_of_two_vectors::single")
...
context("ds.make.o()::expt::product_of_two_vectors::multiple")
test_that("multiply two vectors",
{
  connect.all.datasets()
...
context("ds.make.o()::expt::division_of_two_vectors::multiple")
...
context("ds.make.o()::expt::division_of_two_vectors::single")
test_that("divide two vectors",
{
  connect.dataset.1()
...
context("ds.make.o()::expt::substract_of_two_vectors::multiple")
...
context("ds.make.o()::expt::substract_of_two_vectors::single")
test_that("substract two vectors",
{
  connect.dataset.1()
...
context("ds.make.o()::expt::sum_of_constant::single")
...
context("ds.make.o()::expt::substract_of_constant::single")
...
context("ds.make.o()::expt::divide_of_constant::single")
...
context("ds.make.o()::expt::multiply_of_constant::single")
...
context("ds.make.o()::expt::sum_of_constant::multiple")
test_that("apply the the sum a vector and a constant value",
{
  connect.all.datasets()
  constant.value <- sample(1:200,1)
...
context("ds.make.o()::expt::substract_of_constant::multiple")
test_that("substract a constant value to all the values of a vector",
{
  connect.all.datasets()
  constant.value <- sample(1:200,1)
...
context("ds.make.o()::expt::divide_of_constant::multiple")
test_that("divide a constant value to all the values of a vector",
{
  connect.all.datasets()
  constant.value <- sample(1:200,1)
...
context("ds.make.o()::expt::multiply_of_constant::multiple")
test_that("multiply a constant value to all the values of a vector",
{
  connect.all.datasets()
  constant.value <- sample(1:200,1)
