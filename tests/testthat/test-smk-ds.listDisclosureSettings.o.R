...
# context("dsBetaTestClient::ds.listDisclosureSettings.o::smk")
...
context("ds.listDisclosureSettings.o::smk::check results")
...
# context("dsBetaTestClient::ds.listDisclosureSettings.o::smk done")
