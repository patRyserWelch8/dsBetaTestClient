...
# context("dsBetaTestClient::ds.tapply.assign.o:args test")
...
context("ds.tapply.assign.o::arg::test errors")
test_that("tapply_erros", {
    res1 <- ds.tapply.assign.o()
    ...
    res2 <- ds.tapply.assign.o('D$LAB_TSC')
    ...
    res3 <- ds.tapply.assign.o('D$LAB_TSC', 'D$GENDER')
...
# context("dsBetaTestClient::ds.tapply.assign.o:arg done")
