...
context("ds.var.o()::math::positive_result::multiple")
...
context("ds.var.o()::math::positive_result::single")
test_that("variance >=0",
{
  connect.dataset.1()
  .test.variance.positive.combine('D$INTEGER')
...
context("ds.var.o()::math::square_root_std::single")
...
context("ds.var.o()::math::square_root_std::multiple")
test_that("variance is to the power of 2 of the standard deviation",
 {
   connect.all.datasets()
...
context("ds.var.o()::math::location::parameter::single")
...
context("ds.var.o()::math::location::parameter::multiple")
test_that("var (X+a) = Var(X)",
{
  connect.all.datasets()
  .test.location.parameter('D$INTEGER')
...
context("ds.var.o()::math::scale::single")
...
context("ds.var.o()::math::scale::multiple")
test_that("var (aX) = a^2Var(X)",
{
  connect.all.datasets()
  .test.scale('D$INTEGER')
