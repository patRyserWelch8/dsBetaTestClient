...
{
   levels <- ds.asFactor.o(variable.name,variable.recoded, datasources = ds.test_env$connection.opal)
...
{
   factor.server <- ds.asFactor.o(variable.name,variable.recoded, datasources = ds.test_env$connection.opal)
