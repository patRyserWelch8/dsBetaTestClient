...
context("ds.mean.o()::expt::split::multiple")
...
context("ds.mean.o()::expt::large_values::single")
test_that("combined data set",
{
  connect.dataset.1()
...
context("ds.mean.o()::expt::large_values::multiple")
test_that("combined data set",
{
  connect.all.datasets()
