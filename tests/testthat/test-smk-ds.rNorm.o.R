...
# context("dsBetaTestClient::ds.rNorm.o::smk")
...
# context("dsBetaTestClient::ds.rNorm.o:smk simple test")
context("ds.rNorm.o::smk::simple test")
...
# context("dsBetaTestClient::ds.rNorm.o::smk done")
