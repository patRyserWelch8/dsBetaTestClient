...
context("ds.rPois.o()::math::lambda equal mean and var::single")
...
context("ds.rPois.o()::math::lambda equal mean and var::multiple")
test_that("lamdba == mean and lambda == var",
{
...
context("ds.rPois.o()::math::distributions comparison::single")
test_that("changes in distribution",
{
  connect.dataset.3()
  seed <- random.number/1000
