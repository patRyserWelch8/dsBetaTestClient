...
context("dsBetaTestClient::ds.asNumeric.o:smoke")
...
context("dsBetaTestClient::ds.asNumeric.o():smoke simple test")

test_that("simple test", {
    res <- ds.asNumeric.o("D$GENDER")
...
context("dsBetaTestClient::ds.asNumeric.o 1:smoke done")
