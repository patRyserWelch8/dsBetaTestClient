...
context("ds.rUnif.o()::math::mean_variance::single")
...
context("ds.rUnif.o()::math::distributions comparison::single")
...
context("ds.rUnif.o()::math::distributions comparison::multiple")
test_that("changes in distribution",
{
