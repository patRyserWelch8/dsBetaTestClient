...
# context("dsBetaTestClient::ds.rBinom.o::smk")
...
# context("dsBetaTestClient::ds.rBinom.o::smk simple test")
context("ds.rBinom.o::smk::simple test")
...
# context("dsBetaTestClient::ds.rBinom.o::smk done")
